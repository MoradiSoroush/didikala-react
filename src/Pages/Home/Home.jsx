                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/1.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="carousel-item">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/2.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="carousel-item">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/3.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="carousel-item">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/4.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="carousel-item">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/5.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="carousel-item">
                    <a class="main-slider-slide" href="#">
                      <img
                        src="./img/main-slider/slider-responsive/6.jpg"
                        alt=""
                        class="img-fluid"
                      />
                    </a>
                  ...
                  <div class="category-slider owl-carousel">
                    <div class="item">
                      <a href="#" class="promotion-category">
                        <img
                          src="./img/category/notebook-computer.png"
                          alt=""
                        />
                    ...
                    <div class="item">
                      <a href="#" class="promotion-category">
                        <img
                          src="./img/category/lifeline-in-a-heart-outline.png"
                          alt=""
                        />
                        <h4 class="promotion-category-name">
                    ...
                    <div class="item">
                      <a href="#" class="promotion-category">
                        <img
                          src="./img/category/restaurant-cutlery-circular-symbol-of-a-spoon-and-a-fork-in-a-circle.png"
                          alt=""
                        />
                        <h4 class="promotion-category-name">
                          خوردنی و آشامیدنی
